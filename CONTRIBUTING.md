...
Collector plugin to gather metrics from the Apache webserver.
...
* Whether your contribution is for a bug fix or a feature request, **create an [Issue](https://github.com/intelsdi-x/snap-plugin-collector-apache/issues/new)** and let us know what you are thinking
